...
```html
<div class="control-card" data-state="off" data-device-id="238" onclick="toggleRoomControl(this)">
  <img class="control-icon" src="images/icons/icon-small-light-off.svg" alt="Spots Hall">
...
let cmdUrl = `${HUBITAT_BASE_URL}/devices/${device}/${encodeURIComponent(command)}`;
